...
RSpec.describe Acw::Client do
  ...
  describe '#create_contact', :vcr do
    context 'success' do
      ...
      let(:result) do
        client.create_contact({ email: "fulanodetal2@sicrano.com", firstName: "Fulano", lastName: "Sicrano", phone: "1231123123" })
      end
  ...
  describe '#sync_contact', :vcr do
    context 'success' do
      ...
      let(:result) do
        client.sync_contact({ email: "fulanodetal3@sicrano.com", firstName: "Fulano2", lastName: "Sicrano2", phone: "1231123123" })
      end
  ...
  describe '#retrieve_contact_by_email', :vcr do
    context 'success' do
      ...
      let(:result) do
        result = client.retrieve_contact_by_email("someone@email.com")
      end
      ...
      it 'has a correct contact' do
        expect(result.value.dig("contacts").first.dig("id")).to eq("349151")
      end
    end
  end
